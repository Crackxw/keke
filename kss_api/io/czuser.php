...
function HY_61a2df774f5c488f97($HY_fc12e3cf6043961fb3 = 1)
{
...
if ($HY_c27c05c8ec8b51c4d4["endtime"] < PETIME) {
	$HY_c27c05c8ec8b51c4d4["endtime"] = $HY_c27c05c8ec8b51c4d4["starttime"] + ($HY_c27c05c8ec8b51c4d4["cday"] * 86400);
}
...
if (0 < $HY_c27c05c8ec8b51c4d4["cztimes"]) {
	if ($HY_c27c05c8ec8b51c4d4["keyextattr"] != $HY_0ccc0f3f98ce3ff46a["keyextattr"]) {
		if ((time() + (86400 * 1)) < ($HY_c27c05c8ec8b51c4d4["starttime"] + ($HY_c27c05c8ec8b51c4d4["cday"] * 86400))) {
			exit("kssdata" . QQ139);
		}
	}
...
if (($HY_810d15d31408c982b2["tg_addtimetype"] == 2) && ($HY_c27c05c8ec8b51c4d4["parentuser"] != "")) {
	...
	if (empty($HY_2d296db84ebd30eda4)) {
		...
		$HY_2d296db84ebd30eda4["endtime"] = $HY_2d296db84ebd30eda4["starttime"] + ($HY_2d296db84ebd30eda4["cday"] * 86400);
...
if ($HY_a7e2ecaf0ec8e8367d !== true) {
	hy_fb45b18d1c30ed39eb($HY_2b051c35c3cffb9826, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 251);
	exit("kssdata" . QQ143 . $HY_82d6536edf704aabc5->HY_8def866213a3d931dd());
}

$HY_0ccc0f3f98ce3ff46a["endtime"] = $HY_0ccc0f3f98ce3ff46a["starttime"] + ($HY_0ccc0f3f98ce3ff46a["cday"] * 86400);
...
if ($HY_173d86697f24ffa1ee !== true) {
	hy_fb45b18d1c30ed39eb($HY_2b051c35c3cffb9826, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 258);
...
if (!empty($HY_461e600f70c429982d)) {
	foreach ($HY_461e600f70c429982d as $HY_970be7709f584ff59c ) {
		...
		if ($HY_173d86697f24ffa1ee !== true) {
			hy_fb45b18d1c30ed39eb($HY_970be7709f584ff59c, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 266);
		}
	}
}
