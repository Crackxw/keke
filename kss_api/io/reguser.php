...
function HY_7a4d32b8a6dcbbb930($HY_fc12e3cf6043961fb3 = 1)
{
...
if ($HY_810d15d31408c982b2["softmode"] == "USOFT") {
	if (strlen($HY_500e14df6c9dae523a["czkey"] == "")) {
		if ($HY_810d15d31408c982b2["nokeyreg"] == "0.00") {
			...
			if ($HY_810d15d31408c982b2["freeregs"] == "0") {
...
if (($HY_810d15d31408c982b2["onlyonebdinfo"] == "1") && !empty($HY_500e14df6c9dae523a["bdinfo"])) {
...
if ($HY_f47b2b08a81187ece1 == 0) {
	...
	if ($HY_de628584d0423ad44a === true) {
		$HY_603bdf9407435b4b55 = $HY_5581876e03ef6b60f7["id"];

		if ($HY_810d15d31408c982b2["fregmanagerid"] != 0) {
			$HY_603bdf9407435b4b55 = $HY_810d15d31408c982b2["fregmanagerid"];
		}

		$HY_0ccc0f3f98ce3ff46a = array("managerid" => $HY_603bdf9407435b4b55, "username" => $HY_500e14df6c9dae523a["username"], "password" => $HY_500e14df6c9dae523a["password"], "password2" => $HY_500e14df6c9dae523a["password2"], "cday" => $HY_810d15d31408c982b2["nokeyreg"], "points" => $HY_810d15d31408c982b2["nokeyreg_points"], "tag" => $HY_810d15d31408c982b2["fregtag"], "keyextattr" => $HY_810d15d31408c982b2["fregattr"], "bdinfo" => $HY_500e14df6c9dae523a["bdinfo"], "addtime" => $HY_cfaf262aef3e4af400, "starttime" => $HY_cfaf262aef3e4af400, "endtime" => $HY_cfaf262aef3e4af400 + ($HY_810d15d31408c982b2["nokeyreg"] * 86400), "isusetestkey" => 1, "intro" => "无卡注册");
...
if ($HY_810d15d31408c982b2["softmode"] == "KSOFT") {
	...
	if ($HY_173d86697f24ffa1ee !== true) {
		hy_fb45b18d1c30ed39eb($HY_2b051c35c3cffb9826, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 232);
	...
	if ($HY_173d86697f24ffa1ee !== false) {
		...
		if ($HY_173d86697f24ffa1ee !== true) {
			hy_fb45b18d1c30ed39eb($HY_2b051c35c3cffb9826, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 424);
		}
		...
		if (!empty($HY_461e600f70c429982d)) {
			foreach ($HY_461e600f70c429982d as $HY_970be7709f584ff59c ) {
				...
				if ($HY_173d86697f24ffa1ee !== true) {
					hy_fb45b18d1c30ed39eb($HY_970be7709f584ff59c, $HY_82d6536edf704aabc5->HY_8def866213a3d931dd(), __FILE__, 430);
				}
			}
		}
