...
HY_bd307d155f057feb55('订单金额不符！');

$HY_6c0a3bbd1a07dd755d=HY_0894f1e5fc3fbb7c85($HY_5cd380c79f7cf1ee30['pid']);   
...
HY_bd307d155f057feb55('订单已确定但还未付款，也可能是数据同步问题，如果你支付成功，请等五分钟再查询订单号！');
}else if($HY_4713a5727c89602935 == 'WAIT_SELLER_SEND_GOODS') {  
HY_bd307d155f057feb55('订单已付款，系统在五分钟内会自动发货！');	
...
HY_bd307d155f057feb55('订单已发货，<a href=https://lab.alipay.com/consume/queryTradeDetail.htm?tradeNo='.$HY_daec5176b1ae69ec18.'>请登陆支付宝确认收货</a>！');
}			
}else{	
...
$HY_d9b9d92031149b415a=$HY_82d6536edf704aabc5->HY_7cbdce9f890757a7f0('select `keyfix`,`keys`,`keyspassword` from `kss_z_key_'.$HY_5cd380c79f7cf1ee30['pid'].'_'.$HY_5cd380c79f7cf1ee30['softid'].'` where `ordernum`=\''.$HY_7e3958ca51847ad2e2.'\' limit 0,'.$HY_5cd380c79f7cf1ee30['keycount']);
if(empty($HY_d9b9d92031149b415a)){
$HY_f569c2880da1e9326f='订单已完成，但由于未知的原因注册卡号未找到<br>请记下订单号'.$HY_7e3958ca51847ad2e2.'五分钟后偿试重新查询，如还是无卡请联系销售方！';
}else{
$HY_f569c2880da1e9326f='<textarea style=\'width:300px;height:100px\'>';
if(count($HY_d9b9d92031149b415a)!=$HY_5cd380c79f7cf1ee30['keycount']){
$HY_f569c2880da1e9326f.='注册卡号数量不符，请记下订单号'.$HY_7e3958ca51847ad2e2."并联系销售方\r\n\r\n";
}else{
$HY_f569c2880da1e9326f.="你购买到的注册卡：\r\n";
...
$HY_f569c2880da1e9326f.='</textarea>';
}
HY_bd307d155f057feb55($HY_f569c2880da1e9326f);
}
...
$HY_44d9f262676630e68f=KSSLOGDIR.'saledebug2_log.php';
