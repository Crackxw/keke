...
function HY_acbd3491cb790a062d($HY_fc12e3cf6043961fb3 = 1)
{
...
$HY_934420d37157dbd4eb = array("mysqldatayh" => "数据库优化", "mysqldatabak" => "数据库备份", "mysqlquery" => "执行SQL");
$HY_b07b5c485e84d4d218 = array("mysqldatayh" => "数据库优化", "mysqldatabak" => "数据库备份", "mysqldatabak_down" => "数据库备份下载", "mysqlquery" => "执行SQL");
...
if (array_key_exists($HY_d762a272713d62924f, $HY_b07b5c485e84d4d218)) {
	...
	include (dirname(__FILE__) . DIRECTORY_SEPARATOR . "data" . DIRECTORY_SEPARATOR . $HY_029edc4ee795ba9f1c[0] . ".php");
}
else {
