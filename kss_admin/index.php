...
if ($HY_d762a272713d62924f == "chklogin") {
	$HY_20c31334382a191162 = $_SESSION["loginimg"];
	...
	if ((strlen($HY_241412be0daddcee1f) < 5) || (strlen($HY_729b908f51ba85e460) < 5)) {
		hy_bd307d155f057feb55("用户名或密码长度小于5个字符", 1);
	}

	if ((strlen($HY_7b8e57bcbe09809a9d) != 4) && (strlen($HY_7b8e57bcbe09809a9d) != 6)) {
		hy_bd307d155f057feb55("验证码长度不符", 1);
	}

	if (($HY_241412be0daddcee1f != "test01") && ($HY_20c31334382a191162 != strtoupper($HY_7b8e57bcbe09809a9d))) {
		$_SESSION["loginimg"] = NULL;
		hy_bd307d155f057feb55("验证码错误", 1);
	}
	...
	if (empty($HY_970be7709f584ff59c)) {
		hy_bd307d155f057feb55("用户名或密码错误！", 1);
	}
	...
	if (!empty($HY_4331e4458cfbbf8a57)) {
		...
		if (($HY_e063c928cc3706d2d2 == false) && (count($HY_4331e4458cfbbf8a57) == 5) && in_array($HY_063c1f55878eb36837, $HY_5708dcfb72e8924044)) {
			hy_bd307d155f057feb55("该帐号连续五次登陆失败，您的IP已被锁定，如果你是合法用户请更换IP重试！");
		}
	}
	...
	if ($HY_970be7709f584ff59c["islock"] == "1") {
		...
		hy_647f70962176e88d39($HY_b6925775f05fcc5edf);
		hy_bd307d155f057feb55("您的帐号被锁定，" . (empty($HY_970be7709f584ff59c["lockedinter"]) ? "锁定原因不明" : $HY_970be7709f584ff59c["lockedinter"]) . "！", 1);
	}
	...
	if ($HY_970be7709f584ff59c["endtime"] < hy_cf2f0673819dddd4a1()) {
		...
		hy_bd307d155f057feb55("您的帐号已过期，过期日期" . $HY_970be7709f584ff59c["endtime"] . $HY_24d8b9ac6b4d4723f2, 1);
	}
...
echo time();
echo "\"></div></td>\r\n</tr>\r\n<tr>\r\n<td width=120 nowarp>&nbsp;</td><td><input style=\"margin-top:3px\" type=\"image\" src=\"../kss_inc/images/login_.png\"></td>\r\n</tr>\r\n</table>\t\t\r\n</td>\r\n</tr>\r\n<tr>\r\n<td style=\"background:url(../kss_inc/images/login_06.png);\" width=\"517\" height=\"131\" align=center>";
