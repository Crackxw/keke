...
function HY_430f52c4b9373905d9($HY_fc12e3cf6043961fb3 = 1)
{
...
$HY_505e9274f10eba7fe5 = "from `kss_z_log_" . $HY_825ad51e000ddc6ca5["pid"] . "_" . $HY_c5aaf359b892dfe165 . "` ";
...
if (empty($HY_bc854a58778efeb1d8)) {
	...
	foreach ($HY_bc854a58778efeb1d8 as $HY_970be7709f584ff59c ) {
		...
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_970be7709f584ff59c["opccode"];
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_970be7709f584ff59c["pccode"];
		echo "</td>";
		echo "<td nowrap='nowrap' class=isip>";
		echo long2ip($HY_970be7709f584ff59c["oip"]);
		echo "</td>";
		echo "<td nowrap='nowrap' class=isip>";
		echo long2ip($HY_970be7709f584ff59c["ip"]);
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		...
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_9a00058d39fe9685ab[$HY_970be7709f584ff59c["optype"]];
		echo "</td>";
		echo "</tr>\r\n";
	}
}
