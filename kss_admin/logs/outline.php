...
function HY_18bb9982bd85f0c876($HY_fc12e3cf6043961fb3 = 1)
{
...
$HY_505e9274f10eba7fe5 = "from `kss_tb_log_outline` ";
...
echo "<td nowrap=\"nowrap\" malt=\"用户在线状态时，超出保护时间的情况下，在新机登陆的日期\">强制下线时间</td>\t\t\r\n<td nowrap=\"nowrap\" malt=\"用户在线状态时原来的IP\">原IP</td>\r\n<td nowrap=\"nowrap\" malt=\"新机的网络IP\">新IP</td>\r\n<td nowrap=\"nowrap\" malt=\"用户在线状态时原来的机器码\">原机器码</td>\r\n<td nowrap=\"nowrap\" malt=\"新机的机器码\">新机器码</td>\r\n</tr>\r\n";

if (empty($HY_bc854a58778efeb1d8)) {
	echo "<tr nodata=1 class=trd><td colspan=7>没找到任何日志</td></tr>";
}
else {
	foreach ($HY_bc854a58778efeb1d8 as $HY_970be7709f584ff59c ) {
		...
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo long2ip($HY_970be7709f584ff59c["oldip"]);
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo long2ip($HY_970be7709f584ff59c["newip"]);
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_970be7709f584ff59c["oldpccode"];
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_970be7709f584ff59c["newpccode"];
		echo "</td>";
		echo "</tr>\r\n";
	}
}
