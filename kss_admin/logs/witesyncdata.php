...
function HY_b9e88926f7426814a7($HY_fc12e3cf6043961fb3 = 1)
{
...
$HY_505e9274f10eba7fe5 = "from `kss_tb_sql` ";
...
echo "</td>\r\n</tr>\r\n</table>\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"97%\">\r\n<tr class=\"trhead\">\r\n<td malt=\"ID号\">ID</td>\r\n<td malt=\"记录类型\">Type</td>\r\n<td malt=\"记录产生的日期\">Date</td>\r\n<td malt=\"需同步到备服的SQL语句\">SQL</td>\r\n</tr>\r\n";

if (empty($HY_bc854a58778efeb1d8)) {
	echo "<tr class=trd><td colspan=4>没有需同步的数据</td></tr>";
}
else {
	foreach ($HY_bc854a58778efeb1d8 as $HY_970be7709f584ff59c ) {
		...
		echo "</td>\r\n<td nowrap=\"nowrap\">";
		echo $HY_970be7709f584ff59c["isact"];
		echo "</td>\r\n<td nowrap=\"nowrap\">";
		echo hy_cf2f0673819dddd4a1($HY_970be7709f584ff59c["addtime"]);
		echo "</td>\r\n<td>";
		echo htmlspecialchars($HY_970be7709f584ff59c["sqltext"]);
		echo "</td>\r\n</tr>\r\n";
	}
}
