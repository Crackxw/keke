...
function HY_391bf754a1f070ed8e($HY_fc12e3cf6043961fb3 = 1)
{
...
$HY_505e9274f10eba7fe5 = "from `kss_tb_log_pubuser` ";
$HY_c3249a3797396973c0 = array();
$HY_c3249a3797396973c0["a"] = " `softid`=" . $HY_c5aaf359b892dfe165;
...
echo "</td>\r\n</tr>\r\n</table>\r\n\r\n<table class=\"listtable\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"center\" width=\"99%\">\r\n<tr class=\"trhead\">\r\n<td nowrap=\"nowrap\">ID</td>\r\n<td nowrap=\"nowrap\" >机器码</td>\t\t\r\n<td nowrap=\"nowrap\" >周期开始天</td>\r\n<td nowrap=\"nowrap\" >周期已使用次数</td>\r\n<td nowrap=\"nowrap\" >最后一次验证</td>\r\n</tr>\r\n";

if (empty($HY_bc854a58778efeb1d8)) {
	echo "<tr nodata=1 class=trd><td colspan=5>没找到任何日志</td></tr>";
}
else {
	foreach ($HY_bc854a58778efeb1d8 as $HY_970be7709f584ff59c ) {
		...
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo hy_cf2f0673819dddd4a1($HY_970be7709f584ff59c["nday"], "Y-m-d");
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo $HY_970be7709f584ff59c["ntimes"];
		echo "</td>";
		echo "<td nowrap='nowrap'>";
		echo hy_cf2f0673819dddd4a1($HY_970be7709f584ff59c["lasttime"], "y-m-d H:i:s");
		echo "</td>";
		echo "</tr>\r\n";
	}
}
